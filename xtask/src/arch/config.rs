...
pub(crate) struct RedundantAccessorsThreshold {
    ...
    #[serde(default = "kithara_xtask_core::common::parse::default_wrapper_ctors")]
    ...
    #[serde(default = "kithara_xtask_core::common::parse::default_expose_methods")]
...
impl Default for RedundantAccessorsThreshold {
    fn default() -> Self {
        Self {
            ...
            wrapper_ctors: kithara_xtask_core::common::parse::default_wrapper_ctors(),
            expose_methods: kithara_xtask_core::common::parse::default_expose_methods(),
        }
    }
}
