...
fn apply_seek(
    player: &PlayerImpl,
    delta_seconds: f64,
    dashboard: &mut player_tui::Dashboard,
) -> String {
...
fn apply_volume(player: &PlayerImpl, delta: f32, dashboard: &mut player_tui::Dashboard) {
...
fn refresh_dashboard(dashboard: &mut player_tui::Dashboard, player: &PlayerImpl) {
...
fn run_ui_loop(
    ...
    let dashboard = player_tui::Dashboard::new(file_url, hls_url);
    let mut ui = player_tui::UiSession::new(dashboard)?;
    ui.log_line(&format!(
