...
impl FsLayout {
    ...
    pub fn temp_file(root_dir: &std::path::Path, asset_id: AssetId, rel_path: &CachePath) -> PathBuf {
    ...
    pub fn final_file(root_dir: &std::path::Path, asset_id: AssetId, rel_path: &CachePath) -> PathBuf {
        let asset_dir = Self::asset_dir(root_dir, asset_id);
