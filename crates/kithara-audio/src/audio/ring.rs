...
mod tests {
    ...
    fn consumer_phase_transitions_to_playing_on_first_chunk() {
        ...
        fixture
            .data_tx
            .try_push(Fetch::new(make_chunk(&[0.1, 0.2]), false, 0))
    ...
    fn consumer_phase_seek_pending_to_playing_on_chunk() {
        ...
        fixture
            .data_tx
            .try_push(Fetch::new(make_chunk(&[0.1, 0.2]), false, 1))
    ...
    fn seek_drain_preserves_new_epoch_chunk_after_stale_chunks() {
        ...
        fixture
            .data_tx
            .try_push(Fetch::new(make_chunk(&[0.7, 0.8]), false, 1))
    ...
    fn seek_drain_preserves_new_epoch_eof_after_stale_chunks() {
        ...
        fixture
            .data_tx
            .try_push(Fetch::new(PcmChunk::default(), true, 1))
