...
fn text_role(
    ...
    let (role, skin_active) = match style {
        ...
        TextStyle::PivotArrow => (skin.text.pivot_arrow, None),
        TextStyle::PivotDuration => (skin.text.pivot_duration, None),
        TextStyle::PivotFooter => (skin.text.pivot_footer, None),
        TextStyle::PivotLabel => (skin.text.pivot_label, None),
        TextStyle::PivotRatio => (skin.text.pivot_ratio, None),
        TextStyle::PivotSmall => (skin.text.pivot_small, None),
        TextStyle::PivotTrackArtist => (skin.text.pivot_track_artist, None),
        TextStyle::PivotTrackTitle => (skin.text.pivot_track_title, None),
        TextStyle::PivotTitle => (skin.text.pivot_title, None),
        TextStyle::PivotValue => (skin.text.pivot_value, None),
