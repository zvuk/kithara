...
mod consts {
    ...
    pub(super) const STRESS_ITERATIONS: u32 = 20;
    pub(super) const GATED_VARIANT: usize = 0;
    pub(super) const GATED_SEGMENTS: [usize; 2] = [1, 2];
    pub(super) const GATE_REQUEST_TICKS: u32 = 2_000;
    pub(super) const GATE_HOLD_TICKS: u32 = 4;

    pub(super) const RATE_SEED: u64 = 0xA11C_E5EE_D5EE_0001;
    pub(super) const SCENARIO_DURATION: Duration = Duration::from_secs(60);
    pub(super) const RATE_CHANGE_INTERVAL: Duration = Duration::from_millis(10);
    pub(super) const RATE_PATTERN: [f32; 8] = [0.72, 1.38, 0.86, 1.24, 0.64, 1.55, 0.93, 1.12];
    pub(super) const SEEK_INTERVAL: Duration = Duration::from_millis(500);
    pub(super) const SEEK_STOP_MARGIN: Duration = Duration::from_secs(5);
    pub(super) const SEEK_MIN_SECONDS: f64 = 6.0;
    pub(super) const SEEK_MAX_SECONDS: f64 = 160.0;
    ...
    pub(super) const LADDER_SEGMENTS: usize = 28;
    pub(super) const LADDER_SEGMENT_SECS: f64 = 6.0;
    pub(super) const MIN_RATE_CHANGES: usize = 3_000;
    pub(super) const MIN_SEEKS: usize = 40;
    pub(super) const MIN_OBSERVATIONS_PER_SEEK: usize = 4;
    pub(super) const RATE_SEEK_PROGRESS_BUDGET: Duration = Duration::from_secs(8);
    pub(super) const MONITOR_POLL_INTERVAL: Duration = Duration::from_millis(100);
}
