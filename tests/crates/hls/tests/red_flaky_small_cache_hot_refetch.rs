...
mod consts {
    ...
    pub(super) const READER_SLEEP_MS: u64 = 30;
    pub(super) const MIN_PROGRESS_CHUNKS: usize = 100;
    ...
    /// timeout instead.
    pub(super) const DRAIN_CHUNKS: usize = 400;
    ...
    pub(super) const SEGMENTS: usize = 20;
    pub(super) const SEGMENT_SECS: f64 = 3.0;
}
