...
class KitharaPlayer(config: Config = Config()) {
    ...
    private fun handleEvent(event: FfiPlayerEvent) {
        when (event) {
            ...
            is FfiPlayerEvent.SyncLockAcquired,
            is FfiPlayerEvent.SyncLockLost,
            is FfiPlayerEvent.SyncRelockCommitted,
            is FfiPlayerEvent.SyncDirectionCommitted,
            is FfiPlayerEvent.SyncUnavailable,
